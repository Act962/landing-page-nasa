...
const solutionItems = [
  { name: "ASTRO", icon: "/ASTRO-ICON.png", href: "/astro" },
  { name: "NASACHAT", icon: "/NASACHAT-ICON.png", href: "/nasachat" },
  { name: "NERP", icon: "/NERP-ICON.png", href: "/nerp" },
  { name: "LINNKER", icon: "/LINNKER-ICON.png", href: "/linnker" },
  { name: "ORBIT", icon: "/ORBIT-ICON.png", href: "/orbit" },
  { name: "TRACKING", icon: "/TRACKING-ICON.png", href: "/tracking" },
];
